...
# 👨‍⚕️ "Noa's Tech Academy" - Auto-Lead Capture Agent
...
print("📚 SELLING: Manuel's AI & ML Courses at Noa's Tech Academy")
...
# Default FAQ data for "Noa's Tech Academy"
DEFAULT_FAQ = [
    {
        "question": "What do you sell?",
        "answer": "We offer courses, training, and personalized coaching for companies, all focused on AI and Machine Learning."
    },
    {
        "question": "How much do the courses cost?",
        "answer": "Pricing varies based on the specific course and training needs. We offer customized packages for companies."
    },
    {
        "question": "Do you offer free content?",
        "answer": "Yes! Manuel releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
        "question": "Do you do corporate consulting?",
        "answer": "Absolutely. We specialize in helping companies integrate AI and Machine Learning into their workflows."
    }
]
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Noa's Tech Academy'.
            
            📘 **YOUR KNOWLEDGE BASE (FAQ):**
            {STORE_FAQ_TEXT}
            
            🎯 **YOUR GOAL:**
            1. Answer questions about our AI & ML courses, training, and coaching using the FAQ.
            2. **QUALIFY THE LEAD:** Naturally ask for the following details during the chat:
                - Name
                - Company / Role
                - Email
                - What are they trying to build or learn? (Use Case)
                - Timeline (When do they need it?)
            
            ⚙️ **BEHAVIOR:**
            - **Be Conversational:** Don't interrogate the user. Answer a question, THEN ask for a detail.
            - *Example:* "Our AI training is very comprehensive. It's great for teams. By the way, how large is your team?"
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Manuel and email you." (Don't hallucinate prices).
            """,
